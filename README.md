...
# Next Steps 🏃‍♂️
* Refactor: We took it as an hackaton so the code needs to be refactor and was basically a speed-run
* Integrate IPFS: Storing the imgaes in on IPFS, in a way like 3BOX does would allow to access the avatars accross the wallets.
